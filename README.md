...
### Mandatory Reading/Listening Bank Check

Перед тем как предлагать новое задание на Reading или Listening, ChatGPT обязан сначала проверить соответствующий банк уже использованных материалов:

- `English Roadmap Tree/Tests/Reading/ReadingBank.md` — перед любым новым reading-заданием;
- `English Roadmap Tree/Tests/Listening/ListeningBank.md` — перед любым новым listening-заданием.

Материал, уже присутствующий в банке, нельзя выдавать как новое задание. Повтор разрешён только сознательно — как review, retest или проверка прогресса — и в таком случае нужно прямо сказать, что материал уже проходился.

После назначения или прохождения нового reading/listening-материала соответствующий банк нужно пополнить: дата, название, рабочий уровень и source URL. Если source отсутствует в записи занятия, его можно восстановить по текстовому содержанию только при надёжной идентификации; иначе нужно написать `source not recorded`, а не угадывать.
